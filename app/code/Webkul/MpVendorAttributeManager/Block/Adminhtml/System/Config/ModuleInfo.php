...
class ModuleInfo extends \Magento\Config\Block\System\Config\Form\Field\Heading
{
    ...
    public function render(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        $guideHref = 'https://webkul.com/blog/magento2-marketplace-vendor-attribute-manager/';

        $extensionText = __('Store Extension:');
        $extensionHref = 'https://store.webkul.com/magento2-marketplace-vendor-attribute.html';
