...
module.exports = {
  ...
  plugins: [
    ...
    new CopyWebpackPlugin([
      ...
      {
        from:path.join(__dirname, "/view/base/web/css/"),
        to:'../../../../../../../../pub/static/frontend/{ThemeNamae}/{theme}/en_US/React_React/css/',
        force: true
      },
    {
      from:path.join(__dirname, "/view/base/web/css/"),
      to:'../../../../../../../../magento/pub/static/frontend/{ThemeName}/{theme}/en_US/React_React/css/',
      force: true
    },
      ]),
]
